...
df_new_year_Bangladesh = df_new_year_Bangladesh.astype({'Urban population':'float','CO2 emissions (kt)':'float','Forest area (sq. km)':'float', })
# Print summary statistics of the Austria dataframe
...
print("Mode of Bangladesh:", Belgium_mode)
...
Bangladesh_Forest_co2_corr = df_new_year_Bangladesh['Forest area (sq. km)'].corr(df_new_year_Bangladesh['CO2 emissions (kt)'], method='pearson')
Bangladesh_population_forest_corr = df_new_year_Bangladesh['Urban population'].corr(df_new_year_Bangladesh['Forest area (sq. km)'], method='pearson')
...
print("Relationship between CO2 emissions and Forest area in Bangladesh :",Bangladesh_Forest_co2_corr)
print("Relationship between Urban population and Forest area in Bangladesh :",Bangladesh_population_forest_corr)
print("Relationship between Urban population and CO2 emissions in Bangladesh :",Bangladesh_population_co2_corr)


# create a multi-level column index from column_cor and set it as the columns of df_corelations
column_cor = [['Belgium','Urban population'],['Austria','Urban population1'],['Azerbaijan','Urban population2'],['Bangladesh','Urban population3']]
corelations = {
    "Urban population": {
...
plt.plot(df_new_country_multiindex.index, df_new_country_multiindex["Bangladesh_Urban population"], label="Bangladesh", linestyle=":",linewidth=4.0,color="#458B74")
plt.plot(df_new_country_multiindex.index, df_new_country_multiindex["Bahrain_Urban population"], label="Bahrain", linestyle="-",linewidth=4.0,color="#4daf4a")
plt.plot(df_new_country_multiindex.index, df_new_country_multiindex["Azerbaijan_Urban population"], label="Azerbaijan", linestyle="-",linewidth=4.0,color="#984ea3")
plt.plot(df_new_country_multiindex.index, df_new_country_multiindex["Austria_Urban population"], label="Austria", linestyle="-",linewidth=4.0,color="#ff7f00")
plt.plot(df_new_country_multiindex.index, df_new_country_multiindex["Antigua and Barbuda_Urban population"], label="Antigua and Barabuda", linestyle="-",linewidth=4.0,color="#ffff33")
plt.plot(df_new_country_multiindex.index, df_new_country_multiindex["Bulgaria_Urban population"], label="Bulgaria", linestyle=":",linewidth=4.0,color="#f781bf")
plt.plot(df_new_country_multiindex.index, df_new_country_multiindex["Belgium_Urban population"], label="Belgium", linestyle="-",linewidth=4.0,color="#a65628")
...
plt.figure(figsize=(14, 6), facecolor="white")
plt.plot(df_new_country_multiindex.index, df_new_country_multiindex["Bangladesh_Forest area (sq. km)"], label="Bangladesh", linestyle=":",linewidth=4.0,color="#458B74")
plt.plot(df_new_country_multiindex.index, df_new_country_multiindex["Bahrain_Forest area (sq. km)"], label="Bahrain", linestyle="-",linewidth=4.0,color="#4daf4a")
plt.plot(df_new_country_multiindex.index, df_new_country_multiindex["Azerbaijan_Forest area (sq. km)"], label="Azerbaijan", linestyle="-",linewidth=4.0,color="#984ea3")
plt.plot(df_new_country_multiindex.index, df_new_country_multiindex["Austria_Forest area (sq. km)"], label="Austria", linestyle="-",linewidth=4.0,color="#ff7f00")
plt.plot(df_new_country_multiindex.index, df_new_country_multiindex["Antigua and Barbuda_Forest area (sq. km)"], label="Antigua and Barabuda", linestyle="-",linewidth=4.0,color="#ffff33")
plt.plot(df_new_country_multiindex.index, df_new_country_multiindex["Bulgaria_Forest area (sq. km)"], label="Bulgaria", linestyle=":",linewidth=4.0,color="#0000EE")
plt.plot(df_new_country_multiindex.index, df_new_country_multiindex["Belgium_Forest area (sq. km)"], label="Belgium", linestyle="-",linewidth=4.0,color="#a65628")
...
plt.figure(figsize=(14, 6), facecolor="white")
plt.scatter(df_new_country_multiindex.index, df_new_country_multiindex["Bangladesh_Urban population"], label="Bangladesh", color="#458B74", marker="v")
...
plt.scatter(df_new_country_multiindex.index, df_new_country_multiindex["Bulgaria_Urban population"], label="Bulgaria", color="#0000EE", marker="^")
plt.scatter(df_new_country_multiindex.index, df_new_country_multiindex["Belgium_Urban population"], label="Belgium", linestyle="-",color="#a65628")
...
plt.figure(figsize=(14, 6), facecolor="white")
plt.scatter(df_new_country_multiindex.index, df_new_country_multiindex["Bangladesh_CO2 emissions (kt)"], label="Bangladesh", color="#458B74", marker="v")
plt.scatter(df_new_country_multiindex.index, df_new_country_multiindex["Bahrain_CO2 emissions (kt)"], label="Bahrain", color="#e31a1c", marker="s")
plt.scatter(df_new_country_multiindex.index, df_new_country_multiindex["Austria_CO2 emissions (kt)"], label="Austria", color="#ff7f00", marker="*")
plt.scatter(df_new_country_multiindex.index, df_new_country_multiindex["Antigua and Barbuda_CO2 emissions (kt)"], label="Antigua and Barabuda", color="#b15928", marker="D")
plt.scatter(df_new_country_multiindex.index, df_new_country_multiindex["Bulgaria_CO2 emissions (kt)"], label="Bulgaria", color="#0000EE", marker="^")
plt.scatter(df_new_country_multiindex.index, df_new_country_multiindex["Belgium_CO2 emissions (kt)"], label="Belgium", linestyle="-",color="#a65628")
...
plt.xticks(np.arange(len(df_new_year_Belgium.columns)), df_new_year_Belgium.columns, rotation=45)
plt.yticks(np.arange(len(df_new_year_Belgium.columns)), df_new_year_Belgium.columns)
...
plt.xticks(np.arange(len(df_new_year_Bangladesh.columns)), df_new_year_Bangladesh.columns, rotation=45)
plt.yticks(np.arange(len(df_new_year_Bangladesh.columns)), df_new_year_Bangladesh.columns)
plt.xlabel("Indicators")
plt.ylabel("Indicators")
